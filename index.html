...
<head>
    ...
    <title>XtremFly - Parachute ascensionnel</title>

    <!-- Search Engine -->
    <meta name="description"
          content="Avec XTREMFLY envolez-vous et goûtez au plaisir extrême du parachute ascensionnel en découvrant
          les merveilles du bassin d’Arcachon."
    >
    <meta name="image" content="http://www.xtremfly.fr/assets/images/img-header.jpg">

    <!-- Schema.org for Google -->
    <meta property="name" content="XtremFly - Parachute ascensionnel.">
    <meta property="description"
          content="Avec XTREMFLY envolez-vous et goûtez au plaisir extrême du parachute ascensionnel en découvrant
          les merveilles du bassin d’Arcachon."
    >
    <meta property="image" content="http://www.xtremfly.fr/assets/images/img-header.jpg">

    <!-- Twitter -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="XtremFly - Parachute ascensionnel.">
    <meta name="twitter:description"
          content="Avec XTREMFLY envolez-vous et goûtez au plaisir extrême du parachute ascensionnel en découvrant
          les merveilles du bassin d’Arcachon."
    >
    <meta name="twitter:site" content="@xtremfly">
    <meta name="twitter:creator" content="@taggaddaaaa">
    <meta name="twitter:image:src" content="http://www.xtremfly.fr/assets/images/img-header.jpg">

    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta property="og:title" content="XtremFly - Parachute ascensionnel."/>
    <meta property="og:description"
          content="Avec XTREMFLY envolez-vous et goûtez au plaisir extrême du parachute ascensionnel en découvrant
          les merveilles du bassin d’Arcachon."
    />
    <meta property="og:image" content="http://www.xtremfly.fr/assets/images/img-header.jpg"/>
    <meta property="og:url" content="http://www.xtremfly.fr"/>
    <meta property="og:site_name" content="XtremFly"/>
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link link display-4" href="#parachute">PARACHUTE<br> ASCENSIONNEL</a>
                </li>
                <!--section departs-->
                <li class="nav-item">
                    <a class="nav-link link display-4" href="#starts">DÉPARTS</a>
                </li>
                <!--dropdown groupes-->
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="vues/pros.html">Groupes / CE</a>
                        <a class="dropdown-item" href="vues/evj.html">EVJF / EVJG</a>
                        <a class="dropdown-item" href="vues/anniversaire.html">Anniversaire</a>
                    </div>
                </li>
                <!--section tarifs-->
                <li class="nav-item">
        ...
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1"
                    style="color:#ffffff;">
                    Envolez-Vous Au Dessus Du Bassin D'Arcachon
                </h1>
            </div>
        ...
        <div class="media-container-row">
            ...
            <div class="card  col-12 col-md-6 col-lg-4">
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style display-7">Session Enfant
                        <br>
                        - de 12ans*
                    </h4>
                    <p class="mbr-text mbr-fonts-style display-7">
                        Accompagnement obligatoire d'un adulte.
                        <br>
                        <br>
                        Valable pour un vol en parachute ascensionnel pour 1 enfant de 6 à&nbsp;11 ans inclus.
                        <br>
                        <br>
                        Durée du vol:
                        <br>
            ...
            <div class="card  col-12 col-md-6 col-lg-4">
                <div class="card-box align-center">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">
                        Valable pour un vol en parachute ascensionnel pour 1 adulte de plus de 12 ans*.
                        <br>
                        <br>
                        Durée du vol:
                        <br>
                    ...
                    <p>+ 20 € l'option vol en Solo**</p>
                </div>
            </div>
            <!--Tarif amoureux-->
            <div class="card  col-12 col-md-6 col-lg-4">
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style display-7">SUNSET LOVER
                        <br>
                        + de 18ans***
                    </h4>
                    <p class="mbr-text mbr-fonts-style display-7">
                        Vol pour deux personnes au coucher du soleil
                        <br/>
                        Avec un cocktail pour deux personnes offert
                        <br/>
                        <br/>
                        Durée du vol:
                        <br>
        ...
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">
                    ...
                    mais pas les chèques bancaires.
                    <br>
                    Il est conseillé de nous téléphoner avant de vous déplacer afin de connaitre le prochain départ du
                    bateau:
                    <br>
...
<!------------------------------------------->
<div class="navbar-buttons mbr-section-btn mbr-section-btn-page">
    <a class="btn btn-sm btn-primary btn-book-flight display-4 btn-page"
            ...
            <div class="container">
                ...
                <div class="modal-body">
                    <p class="mbr-text mbr-fonts-style display-7">
                        ...
                        <a href="vues/pros.html" title="Groupes et CE" name="pros">les groupes et les CE</a>,
                        <a href="vues/anniversaire.html" title="CE" name="anniversaires">les anniversaires</a> et
                        <a href="vues/evj.html" title="EVJF/G" name="evjf/g">les enterrements de vie de jeune
                            fille/garçon</a>
                        , même déguisé!
                    </p>
                    <hr>
...
<div class="modal fade" id="modal-privacy" tabindex="-1" role="dialog" aria-labelledby="Mentions Légales"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="close-modal" data-dismiss="modal">
            ...
            <div class="container">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitlePrivacy">Mentions Légales</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="mbr-text mbr-fonts-style display-7">
                        ...
                        <p style="text-align:justify">Statut du propriétaire : <strong>societe</strong>
                            <br/>
                            Préfixe : <strong>SAS</strong>
                            <br/>
                            Nom de la Société :<strong>MATIMAE</strong>
                            <br/>
                            Adresse : <strong>45 Allée rive droite du canal 33260 Cazaux</strong>
                            <br/>
                            Tél  : <strong>06 73 82 41 02</strong>
                            <br/>
                            Au Capital de :<strong> 0 €</strong>
                            <br/>
                            SIRET :  <strong>0   </strong>R.C.S. :<strong> 0</strong>
                            <br/>
                            Numéro TVA intracommunautaire : <strong>0</strong>
                            <br/>
                            Adresse de courrier électronique : <strong>contact@xtremfly.fr</strong> 
                            <br/>
                             <br/>
                            Le Créateur du site est : <strong>Sabine Caizergues</strong>
                            <br/>
                            Le Responsable de la publication est : <strong>Guillaume Chapel</strong>
                            <br/>
                            Contactez le responsable de la publication : <strong>contact@xtremfly.fr</strong>
                            <br/>
                            ...
                            <br/>
                            L’hebergeur du site est : <strong>1&1 https://www.1and1.fr/ 57200 SARREGUEMINES</strong>
                            <br/>
                            <u><strong>CREDITS :</strong></u> les mentions légales ont étés générées par
                            <strong>
                                <a href="https://www.generer-mentions-legales.com">rédaction de mentions légales</a>
                            </strong>
                            <br/>
                        </p>
                        ...
                        <p style="text-align:justify">
                            <br/>
                            Le proprietaire du site est propriétaire des droits de propriété intellectuelle ou
                            détient les droits d’usage sur tous les éléments accessibles sur le site, notamment
                            ...
                            <a href="mailto:contact@xtremfly.fr?subject=Mentions-legales_sur_www.xtremfly.fr"
                            >contact@xtremfly.fr</a>.
                            <br/>
                        ...
                        <p style="text-align:justify"><strong>4. Liens hypertextes et cookies :</strong>
                            ...
                            du site n’a pas la possibilité de vérifier le contenu des sites ainsi visités  et décline
                            ...
                            obtenues visent à faciliter la navigation ultérieure sur le site, et ont également vocation
                            ...
                            éventuellement, de refuser de la manière décrite à l’adresse suivante : www.cnil.fr
                            <br/>
                        ...
                        <p style="text-align:justify">
                            <strong>5. Protection des biens et des personnes - gestion des données personnelles
                                :</strong>
                            <br/>
                            <br/>
                        ...
                        <p style="text-align:justify">Les bases de données sont protégées par les dispositions de la loi
                            du 1er
...
<!--MODAL Conditions générales de ventes-->
<div class="modal fade" id="modal-legacy" tabindex="-1" role="dialog" aria-labelledby="Conditions générales de ventes"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="close-modal" data-dismiss="modal">
            ...
            <div class="container">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitleLegacy">Conditions générales de ventes</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <p style="text-align:justify">
                        ...
                        La SAS MATIMAE XTREMFLY, adresse du siège social : 45 allée rive droite du canal, 33260 CAZAUX
                        et lieu d'exploitation : bassin d'Arcachon, 33120 ARCACHON. D'autre part: Les personnes
                        effectuant une ou plusieurs réservations pour un vol en parachute ascensionnel et toutes
                        autres activités réservés via la SAS MATIMAE XTREMFLY, ci-après dénommés clients.
                    </p>

                    <hr>

                    <p style="text-align:justify"><strong>Article 1 : RÉSERVATION</strong>
                        <br/>
                        1.1 Pour effectuer une réservation, plusieurs possibilités s'offrent au client: <br>
                        a) En nous contactant par téléphone au 06 73 82 41 02 <br>
                        b) En vous rendant sur notre site internet www.xtremfly.fr rubrique "Réservez votre vol"<br>
                        c) En vous rendant au point info au 8 boulevard Marcel Gounouilhou 33120 Arcachon
                        (en front de mer, derrière les trampolines de plage côté Jetée Thiers)
                    </p>

                    <hr>

                    <p style="text-align:justify">
                        1.2 Plusieurs moyens de paiement sont possibles : carte bancaire, chèque vacances, espèces,
                        virement, paiement en ligne.
                    </p>
                    <p style="text-align:justify"><strong>Article 2: CONDITIONS</strong>
                        <br/>
                        2.1 L’activité dépendant étroitement des conditions météorologiques et des marées, nous
                        demandons au client de prévoir de lui consacrer une demi-journée, voire la journée, l’horaire
                        étant donné à titre indicatif, ce que le client accepte sans réserve. Le responsable du bateau
                        pourra à tout moment décider de son report pour des questions de sécurité. La confirmation de
                        votre activité vous sera confirmée par le responsable du bateau la veille ou le jour même en
                        fonction des dernières prévisions météorologiques.
                        <br>
                        2.2 Pour des raisons de sécurité, le responsable du bateau peut à tout moment décider de
                        reporter ou d'annuler le vol.
                        <br>
                        2.3 Le responsable du bateau se réserve le droit de refuser un client qu'il juge inapte à voler
                        (alcoolisme, prise de substance illicite, sur-poids, forte corpulence, taille, autres)
                        <br>
                        2.4 L'éventuelle décision du responsable du bateau de différer l'heure de vol ou d'annuler le
                        vol, ne peut être un motif aux fins de remboursement. Il en est également ainsi de la décision
                        des clients de refuser, sur place, le vol en parachute ascensionnel.
                        <br>
                        2.5 Les enfants mineurs de moins de 12 ans qui effectuent l’activité doivent être accompagnés
                        au minimum d'une personne majeure qui réglera aussi l’activité en tant qu’accompagnateur du vol
                        (au tarif du vol adulte : 55 euros TTC/pers).
                        <br>
                        2.6 La veille de votre vol, vous devez nous joindre au 06 73 82 41 02 afin de confirmer votre
                        rendez-vous et faire un dernier point météo.
                        <br>
                        2.7 Si vous souhaitez une vidéo de votre vol (à demander impérativement avant le début du vol),
                        la SAS MATIMAE XTREMFLY propose la vidéo et vous remettra la carte SD moyennant 25€. Sauf avis
                        contraire de votre part, la SAS MATIMAE XTREMFLY dispose d'un droit d'usage sur les images
                        réalisés. La SAS MATIMAE XTREMFLY refuse pour raisons de sécurité que vous vous filmiez ou
                        photographiez vous même en vol même avec des harnais, perche...
                        <br>
                        2.8 Des accompagnants qui n'effectuent pas le vol peuvent prendre place sur le bateau moyennant
                        15€ par personne sous réserve de disponibilités sur le bateau.
                    </p>
                    ...
                    <p style="text-align:justify"><strong>Article 3: ANNULATION - VALIDITÉ DU BILLET -
                        ...
                        <br>
                        3.2 Dans le cas où le vol est annulé pour raison de sécurité, la SAS MATIMAE XTREMFLY n'est pas
                        redevable des frais de déplacement ou d'hébergement engagés par les clients pour se rendre au
                        lieu du vol
                        <br>
                        3.3 Hormis les cas de force majeure, en cas d'absence du client à la date et à l'heure du vol,
                        le billet est considéré comme étant consommé. En cas d'absence pour raison médicale, un
                        certificat médical doit être envoyé à l'adresse mail contact@xtremfly.fr et la date du vol
                        sera reportée
                        <br>
                        3.4 Pour vous, mesdames, l'état de grossesse ne peut être un motif de remboursement de votre
                        billet. Il reste cessible à la personne de votre choix et doit être consommé durant sa validité.
                        <br>
                        3.5 Pas de prolongation de la durée de validité ne sera effectuée quelque soit le motif. Le
                        billet
                        devra être utilisé dans la saison en cours.
                    </p>
                    <hr>
                    <p style="text-align:justify"><strong>Article 4: ASSURANCES</strong>
                        <br/>
                        4.1 Le client est informé du fait qu'en cas de sinistre, le responsable a souscrit une police
                        d'assurance usuelle en pareille matière. Celle-ci couvre à concurrence des normes européennes
                        obligatoire
                    </p>
                    <hr>
                    <p style="text-align:justify"><strong>Article 5 : VALIDATION DE LA COMMANDE</strong>
                        ...
                        déclarez en avoir parfaite connaissance. La confirmation de commande vaudra signature et
                        acceptation des opérations effectuées. Un récapitulatif des informations de votre commande et
                        des présentes Conditions Générales, vous sera communiqué en format PDF via l'adresse e-mail de
                        ...
                        transaction. Vous déclarez en avoir parfaite connaissance. La confirmation de commande vaudra
                        signature et acceptation des opérations effectuées. Un récapitulatif des informations de votre
                        commande et des présentes Conditions Générales, vous sera communiqué en format PDF via l'adresse
                        ...
                        la confirmation enregistrée vaudront preuve de la transaction. Vous déclarez en avoir parfaite
                        connaissance. La confirmation de commande vaudra signature et acceptation des opérations
                        effectuées.
                        ...
                        e-mail de confirmation de votre commande. Le fait de valider votre commande implique pour vous
                        l'obligation de payer le prix indiqué. Le règlement de vos achats s'effectue par carte bancaire
                        grâce au système sécurisé WEEZEVENT.
                    </p>
                    <hr>
                    <p style="text-align:justify"><strong>Article 6 : TARIFS</strong>
                        <br/>
                        6.1 Les prix sont TTC et en euros.
                        <br>
                    ...
                    <p style="text-align:justify"><strong>rticle 7: APTITUDE MÉDICALE </strong>
                        ...
                        ou les séquelles cardiovasculaires, les traumatismes crâniens et du rachi, certaines opérations
                        chirurgicales, problème ORL, nécessite un avis médical.
                        <br>
                        7.2 Pour vous, mesdames, l'état de grossesse est fortement déconseillé.
                        <br>
                        7.3 Ne pas être sous l'emprise d'un état alcoolique ou d'absorption de substance illicite.
                        <br>
                        7.4 Il est recommandé d'avoir mangé correctement avant d'effectuer le vol
                    </p>

                    <hr>

                    <p style="text-align:justify"><strong>Article 8: DROIT A L’IMAGE ET LISTE DE DIFFUSION</strong>
                        <br/>
                        8.1 A l’occasion de cette activité, les clients (adultes et / ou enfants ) seront filmés et/ou
                        photographiés pendant leur vol en parachute ascensionnel. Les vidéos et/ou photos seront
                        utilisés et publiés sur différents supports de communication: publication sur la page internet
                        www.xtremfly.fr et sur les réseaux sociaux. Sauf mention contraire signalisée au bas de ces
                        conditions générales, les clients donnent leur autorisation au droit à l’image à la société
                        SAS MATIMAE XTREMFLY.
                        <br>
                        8.2 Les clients acceptent d’être sur la liste de diffusion de la société SAS MATIMAE XTREMFLY
                        et de recevoir toutes informations par mail et/ou SMS provenant de cette société.
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
...
<input name="cookieData" type="hidden"
       data-cookie-text="Nous utilisons des cookies pour vous offrir une meilleure expérience sur notre site.
