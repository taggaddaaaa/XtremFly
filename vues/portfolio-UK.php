...
<section class="menu cid-qJWKHrsea5" id="navigation">
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link link display-4 text-white" href="index-UK.php#parachute">PARASAILING</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link link display-4 text-white" href="index-UK.php#starts">STARTS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link link display-4 text-white" href="index-UK.php#price">PRICES</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link link display-4 text-white" href="#">PICTURES</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link link display-4 text-white" href="index-UK.php#contact">CONTACT</a>
                </li>
            </ul>
        </div>
        <div class="navbar-buttons mbr-section-btn mbr-section-btn-nav">
            ...
            >BOOK A FLIGHT</a>
            <a class="btn btn-sm btn-white btn-lang-en display-4" href="../index.php"><img
                    src="../assets/images/fr.png" alt="french site"></a>
        </div>
    </nav>
</section>
    ...
    <div class="container" style="padding-bottom: 2rem;">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">XTREMFLY <br>EN IMAGES</h2>
