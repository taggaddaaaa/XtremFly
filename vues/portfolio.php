...
<head>
    ...
    <title>XtremFly - En Images</title>
    ...
    <meta property="name" content="XtremFly - En Images">
    ...
    <meta name="twitter:title" content="XtremFly - En Images">
    ...
    <meta property="og:title" content="XtremFly - En Images"/>
...
<section class="menu cid-qJWKHrsea5" id="navigation">
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link link display-4 text-white" href="../index.php#parachute">PARACHUTE<br>
                        ASCENSIONNEL</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link link display-4 text-white" href="#">EN IMAGES</a>
                </li>
